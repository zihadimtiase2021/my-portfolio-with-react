...
export const portfolioItems = [
  ...
  },
  {
    ...
    uses: "WEBFLOW",
    img: nextlevel_ecom,
    placeholder: nextlevel_ecom_small,
    category: "webflow",
  },
  {
    name: "adslab",
    uses: "WEBFLOW",
    placeholder: adslab_small,
    img: adslab,
    category: "webflow",
  },
  {
  ...
  },
  {
    ...
    placeholder: schaeferundfriends_small,
    category: "webflow",
  },
  {
  ...
  },
  {
    ...
    placeholder: drohne112_webflow_small,
    category: "webflow",
  },
  {
    name: "Slube",
  ...
  },
  {
    ...
    placeholder: m3t_konfigurator_small,
    category: "vanila js",
  },
  {
    name: "Graphics Freak",
    uses: "HTML, Tailwind.css, JS",
    img: graphicsfreak,
    placeholder: graphicsfreak_small,
    category: "vanila js",
  },
  {
    name: "React Quiz App",
    ...
    img: reactQuizApp,
    placeholder: reactQuizApp_small,
    category: "react js",
  },
  {
    name: "M8iT",
...
export const portfolioPopUp = [
  {
    ...
    icon: [
      ...
      { icon: swiperJs, name: "Swiper JS" },
      { icon: css, name: "Css" },
    ],
    description: "I convert this web from Figma to WEBFLOW",
  },
  {
    title: "Nextlevel Ecom",
    link: "https://ecom-unternehmer-staging.webflow.io/",
    placeholder: loading,
    img: [ecom_popup],
    icon: [
      { icon: webflow, name: "Webflow" },
  ...
  {
    title: "adslab",
    link: "https://adslab-staging.webflow.io/social-media-organic-adslab",
    placeholder: loading,
    img: [adslab_popup],
    icon: [
      { icon: webflow, name: "Webflow" },
  ...
  {
    title: "Schaeferund Friends",
    link: "https://schaeferundfriends.webflow.io/",
    placeholder: loading,
    img: [schea_popup],
    icon: [
      { icon: webflow, name: "Webflow" },
